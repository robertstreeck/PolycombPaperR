...
#computeMatrix scale-regions -m 5000 -a 3000 -b 3000 -bs 50 --skipZeros --missingDataAsZero --metagene -p 18 -S RestingHemocyteK3772H3K27me3L2Ration.bw RestingHemocyteCH105PolIIL2Ration.bw RestingHemocyteCH075H3K36me3L2Ration.bw -R K27C1_Table.gtf K27C2_Table.gtf K27C3_Table.gtf -o GeneBody_K27C_ScaledRegions2.gz;
...
plotProfile -m GeneBody_K27C_ScaledRegions2.gz -o Fig1F_GeneBody_ScaledRegions_profile.pdf \
    --regionsLabel non-Pc Pc-I Pc-H --samplesLabel H3K27me3 PolII H3K36me3 \
    --colors "#88CCEE" "#CC6677" "#DDCC77" --plotHeight 3 --plotWidth 10;
...
#computeMatrix reference-point -a 3000 -b 3000 -bs 50 --skipZeros --missingDataAsZero --metagene -p 18 -S RestingHemocyteCH075H3K4me1L2Ration.bw RestingHemocyteCH075H3K4me3L2Ration.bw RestingHemocyteCH098H3K27acL2Ration.bw -R K27C1_Table.gtf K27C2_Table.gtf K27C3_Table.gtf -o critical_K27C_ReferencePoint2.gz;
...
plotProfile -m critical_K27C_ReferencePoint2.gz -o Fig1F_ReferencePoint_profile.pdf \
    --regionsLabel non-Pc Pc-I Pc-H --samplesLabel H3K4me1 H3K4me3 H3K27ac \
    --colors "#88CCEE" "#CC6677" "#DDCC77" --plotHeight 3 --plotWidth 10;
